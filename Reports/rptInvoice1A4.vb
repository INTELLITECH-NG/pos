...
Public Class rptInvoice1A4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntelliSalesPOS.rptInvoice1A4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoice1A4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoice1A4 = New rptInvoice1A4()
        rpt.Site = Me.Site
        Return rpt
    End Function
