...
Public Class rptInvoiceA4
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntelliSalesPOS.rptInvoiceA4.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvoiceA4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvoiceA4 = New rptInvoiceA4()
        rpt.Site = Me.Site
        Return rpt
    End Function
