...
Public Class rptOutputTax
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntelliSalesPOS.rptOutputTax.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOutputTax
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOutputTax = New rptOutputTax()
        rpt.Site = Me.Site
        Return rpt
    End Function
